    ...
    return (
        <motion.div 
            ...
            <div className="max-w-xl max-lg:max-w-md pt-2">
                <motion.h1 variants={textAnimation} className="font-bold text-7xl max-lg:text-6xl  text-white font-oswald leading-[100%] mb-10 max-sm:text-5xl max-[360px]:text-4xl max-[360px]:mb-6">Автоматизируем малый и средний бизнес</motion.h1>
